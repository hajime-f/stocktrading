...
本プログラムは、次の２つの予測モデルを使います。

- 翌営業日の終値が、当日の終値から上がるか否かを予測するモデル（日足モデル）
- 当日の株価が20分以内に上がるか否かを予測するモデル（分足モデル）

いずれも、時系列データに基づいて上がる（クラス１）か上がらない（クラス０）かを予測する深層学習モデルです。
...
つまり、ラベル１データの発見率は6％、発見したデータが本当にラベル１である確率は82％です。
